  ...
  return (
    <>
      <div className="flex mt-10">
        <div className="inner_text w-1/2 p-10 text-sm mt-10">
          <p className=" pr-20 pt-20 pb-20 p-3">
            <span className="text-4xl font-bold text-indigo-500">
              Hii my name is Akshay sutar
            </span>
            . I am a full stack web Devoloper this is my my personal portfolio
            website
          </p>
        </div>
      ...
      <div className="social  w-1/2 mt-10 justify-center text-center ml-20 mb-10">
        <ul className="justify-between mb-2 text-indigo-400 flex text-center justify-center">
          <motion.li
            whileHover={{
              scale: [1.5, 3, 3, 1, 1],
